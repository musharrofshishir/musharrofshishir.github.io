...
function Hero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set(headlineRef.current, { scale: 0.96, transformOrigin: 'center center' })
      ...
      // Staggered headline reveal and content smooth zoom-in
      ...
      <div ref={headlineRef} className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 w-full text-center">
        ...
        <div className="overflow-hidden mb-8">
          <p className="hero-line font-sans text-xs tracking-[0.3em] uppercase text-accent">
            Portfolio — 2021 / {new Date().getFullYear()}
          </p>
        </div>
        ...
        >
          Transforming complex product ideas into fluid, high-fidelity interfaces. Bridging the gap between abstract design and technical precision with React, Next.js, and GSAP.
        </p>
